...
class StabilityReport:
    ...
    migration_rate: float | None  # Per month (if time data available)
    ...
    volatility: float | None  # Standard deviation of modification counts
...
def _calculate_volatility(values: list[int]) -> float | None:
